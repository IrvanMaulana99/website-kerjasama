...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Website Utama Kerja Sama Bandung" />
    <meta
      name="keywords"
      content="kota bandung, kerjasama, kerja sama kota bandung, kerjasama kota, kota bandung kerjasama"
    />
    <meta name="author" content="elemis" />
    <title>Bagian Kerja Sama Kota Bandung</title>
    <link rel="shortcut icon" href="frontend/img/favicon-kerjasama.png" />
    <link rel="stylesheet" href="frontend/css/plugins.css" />
    <link rel="stylesheet" href="frontend/css/style.css" />
    <link rel="stylesheet" href="frontend/css/colors/sky.css" />
    <link
      rel="preload"
      href="frontend/css/fonts/urbanist.css"
      as="style"
      ...
      <div class="container py-3 py-md-5">
        <nav class="d-inline-block" aria-label="breadcrumb">
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="#">Pengajuan Kerjasama</a></li>
          </ol>
        </nav>
        <!-- /nav -->
      </div>
          ...
          <div class="col-lg-8">
            ...
            <form class="needs-validation" novalidate>
              <div class="row g-3">
                ...
                <div class="col-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="nama" placeholder="instansi x" required>
                    <label for="address" class="form-label">Nama Instansi</label>
                    <div class="invalid-feedback"> Pastikan Alamat Instansi Sesuai </div>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="Alamat" placeholder="jl.cangkurileng no.08902" required>
                  ...
                  <div class="form-floating">
                    <input type="text" class="form-control" id="No-KTP" placeholder="1234567890123456" required>
                    <label for="address" class="form-label">No KTP</label>
                    <div class="invalid-feedback"> Max 16 Nomor </div>
                  </div>
                </div><div class="col-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="No-Telp" placeholder="8907899807" required>
                    <label for="address" class="form-label">No Telephone</label>
                ...
                <div class="col-md-5">
                  <div class="form-select-wrapper">
                    <select class="form-select" id="pengajuan" required>
                      ...
                      <form action="myform.cgi" style="margin: 20px;">
                ...
                <a href="#" class="btn btn-blue rounded-pill">Ajukan Kerjasama</a>
                <!-- <div class="col-md-4">
                  <div class="form-select-wrapper">
  ...
  <footer class="bg-navy text-inverse">
    <div class="container pt-12 pt-lg-6 pb-13 pb-md-15">
      <div class="d-lg-flex flex-row align-items-lg-center">
        ...
        >
          Silahkan hubungi kami untuk mengenal lebih lanjut
        </h3>
        <a
          href="contact.html"
          class="btn btn-outline-primary rounded-pill mb-0 text-nowrap"
          >Hubungi Kami</a
        >
      </div>
      <!--/div -->
      ...
      <div class="row gy-6 gy-lg-0">
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            ...
            />
            <p class="mb-4">
              Bagian Kerja Sama Kota Bandung <br class="d-none d-lg-block" />
            </p>
        ...
        <div class="col-md-12 col-lg-3">
          <div class="widget">
            ...
            <p class="mb-5">Melayani Fasilitasi Kerja Sama di Kota Bandung</p>
          </div>
        </div>

        <div class="col-md-4 col-lg-3">
          <div class="widget">
            <h4 class="widget-title text-white mb-3">Alamat Kantor</h4>
            <address class="pe-xl-15 pe-xxl-17">
              Jl. Aceh No.51, Babakan Ciamis, Kec. Sumur Bandung, Kota Bandung
            </address>
            <a href="mailto:#">bagiankerjasama@bandung.go.id</a><br />
            (022) 4204358
          </div>
          <!-- /.widget -->
        </div>
        ...
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            <h4 class="widget-title text-white mb-3">Website Terkait</h4>
            <ul class="list-unstyled mb-0">
              <li><a href="#">Pemerintah Daerah Kota Bandung</a></li>
              <li><a href="#">Pemerintah Daerah Provinsi Jawa Barat</a></li>
              <li><a href="#">Kementrian Dalam Negeri</a></li>
              <li><a href="#">Kementrian Luar Negeri</a></li>
            </ul>
          </div>
          <!-- /.widget -->
        </div>
