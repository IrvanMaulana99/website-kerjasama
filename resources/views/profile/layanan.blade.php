...
@include('layout.heder')
    <section class="wrapper image-wrapper bg-image bg-overlay text-white" data-image-src="frontend/img/photos/bg1.jpg">
      <div class="container pt-19 pt-md-21 pb-18 pb-md-20 text-center">
        <div class="row">
          <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6 mx-auto">
            <h1 class="display-1 text-white mb-3">Layanan Kami</h1>
            <p class="lead fs-lg px-md-3 px-lg-7 px-xl-9 px-xxl-10">Menunjukan Efektivitas dan Efisiensi dalam fasilitasi Kerja Sama Daerah yang Berkualitas</p>
          </div>
          <!-- /column -->
        </div>
        <!-- /.row -->
    ...
    <section class="wrapper bg-light">
      <div class="container pt-14 pb-12 pt-md-16 pb-md-14">
        <div class="row gx-lg-8 gx-xl-12 gy-10 mb-lg-22 mb-xl-24 align-items-center">
            ...
            <div class="row gx-md-5 gy-5">
              <div class="col-md-5 offset-md-1 align-self-end">
                <div class="card bg-pale-yellow">
                  <div class="card-body">
                    <img src="frontend/img/icons/lineal/telephone-3.svg" class="svg-inject icon-svg icon-svg-md text-yellow mb-3" alt="" />
                    <h4>Layanan 1</h4>
              ...
              <div class="col-md-6 align-self-end">
                <div class="card bg-pale-red">
                  <div class="card-body">
                    <img src="frontend/img/icons/lineal/shield.svg" class="svg-inject icon-svg icon-svg-md text-red mb-3" alt="" />
                    <h4>Layanan 2</h4>
                    <p class="mb-0">Nulla vitae elit libero, a pharetra augue. Donec id elit non mi porta.</p>
                  </div>
                  <!--/.card-body -->
              ...
              <div class="col-md-5">
                <div class="card bg-pale-leaf">
                  <div class="card-body">
                    <img src="frontend/img/icons/lineal/cloud-computing-3.svg" class="svg-inject icon-svg icon-svg-md text-leaf mb-3" alt="" />
                    <h4>Layanan 3</h4>
              ...
              <div class="col-md-6 align-self-start">
                <div class="card bg-pale-primary">
                  <div class="card-body">
                    <img src="frontend/img/icons/lineal/analytics.svg" class="svg-inject icon-svg icon-svg-md text-primary mb-3" alt="" />
                    <h4>Layanan 4</h4>
          ...
          <!--/column -->
          <div class="col-lg-5">
            <h2 class="fs-15 text-uppercase text-muted mb-3">Layanan Kami</h2>
            <h3 class="display-4 mb-5">Kami melayani kebutuhan anda untuk fasilitasi Kerja Sama</h3>
      ...
      <div class="container py-14 pt-md-16 pt-lg-0 pb-md-16">
        <div class="row text-center">
          <div class="col-lg-10 mx-auto">
            <div class="mt-lg-n20 mt-xl-n22 position-relative">
              ...
              <!-- <video poster="frontend/img/photos/movie.jpg" class="player" playsinline controls preload="none">
                <source src="frontend/media/movie.mp4" type="video/mp4">
                <source src="frontend/media/movie.webm" type="video/webm">
              </video> -->
              <div class="player" data-plyr-provider="youtube" data-plyr-embed-id="6dvxZ2JxSLc"></div>
            </div>
          </div>
          <!--/column -->
        </div>
        ...
        <div class="row text-center">
          <div class="col-lg-9 mx-auto">
            <h2 class="fs-15 text-uppercase text-muted mb-3 mt-12">Proses Kerja</h2>
            <h3 class="display-4 mb-0 text-center px-xl-10 px-xxl-15">Proses Kerja kami dalam fasilitasi Kerja Sama dengan Pemerintah Kota Bandung</h3>
            <div class="row gx-lg-8 gx-xl-12 process-wrapper text-center mt-9">
              <div class="col-md-4"> <img src="frontend/img/icons/lineal/light-bulb.svg" class="svg-inject icon-svg icon-svg-md text-primary mb-3" alt="" />
                <h4 class="mb-1">Pengajuan</h4>
                <p>Nulla vitae elit libero elit non porta gravida eget metus cras.</p>
              </div>
              <!--/column -->
              <div class="col-md-4"> <img src="frontend/img/icons/lineal/settings-3.svg" class="svg-inject icon-svg icon-svg-md text-red mb-3" alt="" />
                <h4 class="mb-1">Pengajuan Diproses</h4>
                <p>Nulla vitae elit libero elit non porta gravida eget metus cras.</p>
              </div>
              <!--/column -->
              <div class="col-md-4"> <img src="frontend/img/icons/lineal/design.svg" class="svg-inject icon-svg icon-svg-md text-leaf mb-3" alt="" />
                <h4 class="mb-1">Diskusi Pengajuan</h4>
                <p>Nulla vitae elit libero elit non porta gravida eget metus cras.</p>
              </div>
              <!--/column -->
            </div>
    ...
    <section class="wrapper bg-light">
      <div class="container py-14 py-md-16">
        ...
        <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
          <div class="col-lg-7 order-lg-2">
            <figure><img class="w-auto" src="frontend/img/illustrations/i7.png" srcset="frontend/img/illustrations/i7@2x.png 2x" alt="" /></figure>
          </div>
          <!--/column -->
          <div class="col-lg-5">
